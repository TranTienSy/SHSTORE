    ...
    public void insert(NhanVien entity) {
        try {
            ...
            JDBCHelper.update("INSERT INTO NHANVIEN VALUES  (?,?,?,?,?,?,?,?,?,?,?,?)", entity.getMaNV(), entity.getHoTen(), entity.isGioiTinh(), entity.getNgaySinh(), entity.getSdt(),
                    entity.getEmail(), entity.getHinh(), entity.getMaCV(), entity.getDiaChi(), entity.getNgayVaoLam(), entity.getMatKhau(), entity.getTTLamViec());
        } catch (Exception ex) {
    ...
    public void update(NhanVien entity) {
        try {
            ...
            JDBCHelper.update("UPDATE NHANVIEN SET HOTEN = ?, GIOITINH = ?,NGAYSINH = ?,"
                    ...
                    entity.getEmail(), entity.getHinh(), entity.getMaCV(), entity.getDiaChi(), entity.getNgayVaoLam(), entity.getMatKhau(), entity.getTTLamViec(), entity.getMaNV());
        } catch (Exception ex) {
    ...
    public NhanVien selectbyID(String id) {
        try {
            ...
            while (rs.next()) {
                ...
                nv.setTTLamViec(rs.getBoolean(12));
                return nv;
            }
